...
import com.example.beberagua_lembrete.model.CaucularIngestaoDiaria
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var bt_caucular: Button
    ...
    private lateinit var caucularIngestaoDiaria: CaucularIngestaoDiaria
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        IniciarComponentes()
        caucularIngestaoDiaria = CaucularIngestaoDiaria()

        bt_caucular.setOnClickListener {
            ...
            if (edit_peso.text.toString().isEmpty()){
               ...
               val peso = edit_peso.text.toString().toDouble()
                ...
                caucularIngestaoDiaria.CaucularTotalML(peso,idade)
                resultadoML = caucularIngestaoDiaria.ResultadoML()
    ...
    private fun IniciarComponentes(){
        ...
        bt_caucular = findViewById(R.id.bt_caucular)
